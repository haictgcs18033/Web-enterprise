    ...
    return (
        <div >
            <div className="side-bar">
                <img src={logo} className={`d-block mx-auto logo__admin`} swidth="89px" height="91px" alt="123" />
                <div className="menu">
                    <NavLink to="/admin/dashboard/faculty" className="d-flex align-items-center link" >
                    ...
                    <NavLink to="/admin/dashboard/users" className="d-flex align-items-center link">
