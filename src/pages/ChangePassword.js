        ...
        <div className="changepassword-container">
            <div className="row my-4">
                ...
                <div className="changepassword-wrapform">
                    <form className="changepassword-form" onSubmit={handleSubmit(onSubmit)} onReset={reset} >
                        ...
                        <input className="form-control" name="currentPassword" value={changePassword.currentPassword} 
                        onChange={handleChange} 
                        ref={register}/>
                        <label className="changepassword-label">Password</label>
                        <input className="form-control" name="newPassword" value={changePassword.newPassword} 
                        onChange={handleChange}
                        ref={register}/>
                            <p className='err-message'>{errors.newPassword?.message}</p>
                        <label className="changepassword-label">Confirm Password</label>
                        <input
                            className="form-control"  ref={register} name="confirmPassword" value={changePassword.confirmPassword}
                            onChange={handleChange}/>
                            <p className='err-message'>{errors.newPassword?.message}</p>
