...
export default function StudentCommitment() {
    return (
        <div className={`container ${classes.TermCommitmentContainer}`}>
            ...
            <h3>License</h3>
            <p>Green Plus grants you a revocable, non-exclusive, non- transferable, limited license to download, install and use our service strictly in accordance with the terms of this Agreement.

            These Terms & Conditions are a contract between you and Green Plus (referred to in these Terms & Conditions as "Green Plus", "us", "we" or "our"), the provider of the Green Plus website and the services accessible from the Green Plus website (which are collectively referred to in these Terms & Conditions as the "Green Plus Service").
            ...
            <ul>
                <li>
                    <span className="font-weight-bold">Cookie : </span>
                    <span>small amount of data generated by a website and saved by your web browser. It is used to identify your browser, provide analytics, remember information about you such as your language preference or login information.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Company: </span>
                    <span>when this policy mentions “Company,” “we,” “us,” or “our,” it refers to Green Plus that is responsible for your information under this Privacy Policy.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Country: </span>
                    <span>where Green Plus or the owners/founders of Green Plus are based, in this case is Vietnam.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Customer:</span>
                    <span>refers to the company, organization or person that signs up to use the Green Plus Service to manage the relationships with your consumers or service users.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Device:</span>
                    <span>any internet connected device such as a phone, tablet, computer or any other device that can be used to visit Green Plus and use the services.</span>
                </li>
                <li>
                    <span className="font-weight-bold">IP address:  </span>
                    <span>Every device connected to the Internet is assigned a number known as an Internet protocol (IP) address. These numbers are usually assigned in geographic blocks. An IP address can often be used to identify the location from which a device is connecting to the Internet.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Personnel:</span>
                    <span>refers to those individuals who are employed by Green Plus or are under contract to perform a service on behalf of one of the parties.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Personal Data: </span>
                    <span>any information that directly, indirectly, or in connection with other information — including a personal identification number — allows for the identification or identifiability of a natural person.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Service: </span>
                    <span>refers to the service provided by Green Plus as described in the relative terms (if available) and on this platform.</span>
                </li>
                <li>
                    <span className="font-weight-bold">Third-party service: </span>
                    <span>refers to advertisers, contest sponsors, promotional and marketing partners, and others who provide our content or whose products or services we think may interest you.</span>
                </li>
                <li>
                    <span className="font-weight-bold">	Website: </span>
                    <span>Green Plus’s site, which can be accessed via this URL: https://greenplus.vercel.app.</span>
                </li>
                <li>
                    <span className="font-weight-bold">You: </span>
                    <span>a person or entity that is registered with Green Plus to use the Services.</span>
                </li>
            </ul>
            <h3>
                Restrictions
            ...
            <ul>
                <li>•	Via Email: minhlcgcs18128@fpt.edu.vn</li>
            </ul>
        </div>
    )
}
